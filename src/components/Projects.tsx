...
const Projects = () => {
  const projects = [
    ...
    {
      title: 'Alleos Advanture',
      description: 'Bring the alleos as main characters to big advanture',
      image: 'https://cdn.dribbble.com/userupload/43003734/file/original-9d4ac533ceeaf3813748e889dfc066c7.png?resize=752x&vertical=center',
      tags: ['Godot', 'C#', 'Games'],
      liveUrl: 'https://github.com/secalanraflurry',
      githubUrl: 'https://github.com/secalanraflurry'
    }
